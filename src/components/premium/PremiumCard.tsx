...
export const PremiumCard: React.FC<PremiumCardProps> = ({
  ...
  const translateX = useRef(new Animated.Value(animated ? (animationType === 'slideInLeft' ? -SCREEN_WIDTH : animationType === 'slideInRight' ? SCREEN_WIDTH : 0) : 0)).current;
  ...
  const getPaddingStyle = (): ViewStyle => {
    switch (padding) {
      ...
      case 'sm': return { padding: SPACING[3] };
      case 'md': return { padding: SPACING[4] };
      case 'lg': return { padding: SPACING[5] };
      case 'xl': return { padding: SPACING[6] };
      default: return {};
    }
  };
  ...
  const getMarginStyle = (): ViewStyle => {
    switch (margin) {
      case 'none': return {};
      case 'sm': return { margin: SPACING[2] };
      case 'md': return { margin: SPACING[3] };
      case 'lg': return { margin: SPACING[4] };
      case 'xl': return { margin: SPACING[5] };
      default: return {};
    }
  };
