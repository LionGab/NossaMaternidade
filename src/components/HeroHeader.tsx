    ...
    <>
      ...
      {showBottomGradient && (
        <LinearGradient
          ...
          style={[styles.gradient, { borderBottomLeftRadius: bottomRadius, borderBottomRightRadius: bottomRadius }]}
      ...
      {/* Top right content */}
      {topRightContent && (
        <View style={[styles.topRight, { top: insets.top + Spacing['3'] }]}>
          {topRightContent}
        </View>
      )}
      ...
      {imageSource ? (
        ...
        <View
          style={[
            ...
            {
              height,
              backgroundColor: fallbackColor || (isDark ? colors.background.elevated : ColorTokens.accent.ocean),
