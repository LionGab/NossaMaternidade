  ...
  const { progress, subtitle, daysText, badge } = useMemo(() => {
    if (pregnancyWeek && pregnancyWeek > 0) {
      ...
      return {
        ...
        daysText: daysRemaining > 0 ? `${daysRemaining} dias para o grande dia` : 'A qualquer momento!',
    ...
    >
      ...
      >
        ...
        <View style={styles.progressContainer}>
          <View style={[styles.progressBg, { backgroundColor: isDark ? ColorTokens.overlay.glass : ColorTokens.overlay.card }]}>
            <LinearGradient
          ...
          <RNText style={{ ...styles.daysText, color: colors.text.tertiary }}>
            {daysText}
          </RNText>
        </View>
        ...
        <View style={styles.actions}>
          ...
          >
            ...
            <RNText style={{ ...styles.actionText, color: ColorTokens.accent.coral }}>
              Saude
            </RNText>
          </Pressable>
