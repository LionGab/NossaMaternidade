...
import { Pressable, ViewStyle, PressableStateCallbackType, AccessibilityRole } from 'react-native';
...
export const IconButton: React.FC<IconButtonProps> = ({
  ...
  const getStateStyle = (state: PressableStateCallbackType): ViewStyle => {
