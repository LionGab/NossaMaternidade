  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Título principal */}
        <Heading level="h3" weight="bold" align="center" style={{ marginBottom: Tokens.spacing['4'] }}>
          NathIA - Assistente Virtual de IA
        </Heading>

        {/* Descrição */}
        <Box mb="6">
          <Text size="md" color="secondary" align="center" style={{ lineHeight: Typography.lineHeights.md * 1.5 }}>
            NathIA é uma assistente virtual de inteligência artificial desenvolvida
            para oferecer apoio emocional e informações gerais sobre maternidade.
          </Text>
        </Box>

        {/* Avisos críticos */}
        <Box mb="6">
          <Text size="md" weight="bold" color="primary" style={{ marginBottom: Tokens.spacing['3'] }}>
          ...
          <Box mb="3">
            <Box direction="row" align="flex-start" mb="2">
              ...
              <Box flex={1}>
                <Text size="sm" weight="semibold" color="error" style={{ marginBottom: Tokens.spacing['1'] }}>
