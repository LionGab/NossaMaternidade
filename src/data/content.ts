...
export const AUDIOS_REAIS: ContentItem[] = [
  {
    ...
    isExclusive: true,
    date: 'Hoje',
    description: 'Uma meditação guiada para você encontrar paz no meio da correria. Perfeita para fazer no banho ou antes de dormir.',
  ...
  },
  {
    ...
    isExclusive: true,
    date: 'Ontem',
    description: 'Um áudio sincero sobre os primeiros dias após o parto. A verdade que você precisa ouvir.',
...
export const VIDEOS_INSTAGRAM: ContentItem[] = [
  {
    ...
    isExclusive: true,
    date: 'Há 2 horas',
    description: 'Gravei às 3h da manhã. A realidade que ninguém mostra no Instagram sobre as cólicas.',
