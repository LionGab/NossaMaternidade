...
const DEFAULT_HABITS: Habit[] = [
  {
    id: "1",
    title: "Hidratar o corpo",
    description: "Beba 2L de agua ao longo do dia",
    icon: "water",
    color: "#60A5FA",
    category: "health",
    completed: false,
  ...
  },
  {
    ...
    description: "Escreva 3 coisas pelas quais e grata",
    icon: "heart",
    color: "#F472B6",
  ...
  },
  {
    ...
    description: "30 minutos de atividade que ama",
    icon: "fitness",
    color: "#A78BFA",
    category: "health",
    completed: false,
  ...
  },
  {
    id: "4",
    title: "Autocuidado",
    description: "Skincare, cuidados pessoais",
    icon: "sparkles",
    color: "#F59E0B",
    category: "self-care",
    completed: false,
  ...
  },
  {
    ...
    description: "Durma 7-8 horas de qualidade",
    icon: "moon",
    color: "#818CF8",
    category: "health",
    completed: false,
  ...
  {
    id: "7",
    title: "Conexao amorosa",
    description: "Tempo de qualidade com quem ama",
    icon: "people",
    color: "#EC4899",
    category: "connection",
    completed: false,
  ...
  },
  {
    ...
    description: "15 minutos de leitura",
    icon: "book",
    color: "#14B8A6",
    category: "growth",
    completed: false,
