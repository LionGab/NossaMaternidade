...
const slides: OnboardingSlide[] = [
  {
    ...
    description: 'Sua jornada maternal começa aqui. Conecte-se com uma comunidade de mães, acesse conteúdos exclusivos e receba suporte personalizado.',
    icon: 'heart',
  ...
  },
  {
    ...
    description: 'Nossa inteligência artificial está disponível 24/7 para responder suas dúvidas, oferecer suporte emocional e acompanhar sua jornada.',
    icon: 'chatbubbles',
  ...
  },
  {
    ...
    description: 'Compartilhe experiências, tire dúvidas e construa conexões com outras mães que entendem sua jornada.',
    icon: 'people',
  ...
  },
  {
    ...
    description: 'Artigos, vídeos e guias criados especialmente para cada fase da sua maternidade. Do pré-natal aos primeiros anos.',
    icon: 'book',
