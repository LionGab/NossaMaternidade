      ...
      >
        ...
        <Section title="1. Introdução" colors={colors}>
          <Paragraph colors={colors}>
            A Nossa Maternidade ("nós", "nosso" ou "app") valoriza e respeita a
            privacidade de suas usuárias. Esta Política de Privacidade descreve
            ...
            (LGPD - Lei 13.709/2018) e o Regulamento Geral de Proteção de Dados
        ...
        <Section title="2. Dados Coletados" colors={colors}>
          ...
          <BulletPoint colors={colors}>
            Informações do bebê (nome, data de nascimento)
          </BulletPoint>
          <BulletPoint colors={colors}>Foto de perfil (opcional)</BulletPoint>
          <BulletPoint colors={colors}>
            Dados de saúde emocional (diário, humor, sono)
          </BulletPoint>
          <BulletPoint colors={colors}>
            Conversas com a IA (MãesValente)
          </BulletPoint>
          <BulletPoint colors={colors}>
          ...
          <BulletPoint colors={colors}>
            Endereço IP e dados de localização aproximada (apenas se
            autorizado)
          </BulletPoint>
          <BulletPoint colors={colors}>
            Dados de crash e performance (via Sentry)
          </BulletPoint>
        </Section>
        ...
        <Section title="4. Compartilhamento de Dados" colors={colors}>
          ...
          <BulletPoint colors={colors}>
            ...
            Integração de IA (Gemini) - dados processados conforme Google Cloud
            Privacy
          </BulletPoint>
          <BulletPoint colors={colors}>
            <Text style={{ fontWeight: 'bold', color: colors.text.primary }}>
            ...
            Envio de notificações push (apenas com consentimento)
          </BulletPoint>
          <BulletPoint colors={colors}>
            <Text style={{ fontWeight: 'bold', color: colors.text.primary }}>
              Sentry:
        ...
        <Section title="5. Armazenamento e Segurança" colors={colors}>
          <Paragraph colors={colors}>
            Seus dados são armazenados em servidores seguros da Supabase
            (AWS/GCP) com:
          </Paragraph>
          <BulletPoint colors={colors}>
          ...
          <Paragraph colors={colors} style={{ marginTop: 12 }}>
            ...
            exclusão da conta, dados são anonimizados ou deletados em até 30
            dias (exceto quando retenção é legalmente exigida).
          </Paragraph>
        </Section>
        ...
        <Section title="6. Seus Direitos (LGPD/GDPR)" colors={colors}>
          ...
          <Paragraph colors={colors} style={{ marginTop: 12 }}>
            Para exercer seus direitos, acesse Configurações → Privacidade ou
            envie email para:{' '}
        ...
        <Section title="7. Privacidade de Menores" colors={colors}>
          <Paragraph colors={colors}>
            Nosso app é destinado a adultos (+18 anos). Não coletamos
            intencionalmente dados de menores de 18 anos sem consentimento
            parental. Dados do bebê são armazenados sob responsabilidade da
            mãe/pai.
          </Paragraph>
        </Section>
        ...
        <Section title="8. Cookies e Rastreamento" colors={colors}>
          ...
          <BulletPoint colors={colors}>
            Analytics básico (anonimizado)
          </BulletPoint>

          <Paragraph colors={colors} style={{ marginTop: 12 }}>
            No iOS 14.5+, solicitaremos seu consentimento explícito para
            rastreamento entre apps (App Tracking Transparency).
          </Paragraph>
        </Section>
        ...
        <Section title="9. Transferência Internacional" colors={colors}>
          <Paragraph colors={colors}>
            ...
            (AWS/GCP), mas sempre com garantias adequadas (cláusulas contratuais
            padrão, certificações Privacy Shield quando aplicável).
          </Paragraph>
        </Section>
        ...
        <Section title="10. Alterações nesta Política" colors={colors}>
          <Paragraph colors={colors}>
            ...
            alterações significativas via email ou notificação no app. Última
