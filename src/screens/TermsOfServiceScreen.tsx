      ...
      >
        ...
        <Section title="1. Aceitação dos Termos" colors={colors}>
          <Paragraph colors={colors}>
            Ao criar uma conta ou usar o app Nossa Maternidade ("Serviço",
            "App", "Nossa Maternidade"), você concorda com estes Termos de
            Serviço ("Termos"). Se você não concorda, não utilize o Serviço.
          </Paragraph>
        </Section>
        ...
        <Section title="2. Descrição do Serviço" colors={colors}>
          <Paragraph colors={colors}>
            Nossa Maternidade é uma plataforma digital de suporte emocional e
            informacional para mães, gestantes e cuidadores, oferecendo:
          </Paragraph>
          ...
          <BulletPoint colors={colors}>
            Comunidade de mães (posts, comentários)
          </BulletPoint>
          <BulletPoint colors={colors}>
            Conteúdos educacionais (vídeos, artigos, áudios)
          </BulletPoint>
          <BulletPoint colors={colors}>
            Exercícios de respiração e bem-estar
          </BulletPoint>
        </Section>
        ...
        <Section title="3. Elegibilidade" colors={colors}>
          ...
          <BulletPoint colors={colors}>
            Manterá a segurança de sua senha
          </BulletPoint>
          <BulletPoint colors={colors}>
            É responsável por toda atividade em sua conta
          </BulletPoint>
        </Section>
        ...
        <Section title="4. Responsabilidades do Usuário" colors={colors}>
          ...
          <BulletPoint colors={colors}>
            Usar bots, scrapers ou automação não autorizada
          </BulletPoint>
          <BulletPoint colors={colors}>
        ...
        <Section title="5. Isenção Médica (IMPORTANTE)" colors={colors}>
          ...
          >
            ...
            <Paragraph colors={colors}>
              Este app NÃO substitui atendimento médico profissional. A IA
              (MãesValente) oferece apoio emocional, mas NÃO fornece diagnóstico,
              tratamento ou aconselhamento médico.
            </Paragraph>
            <Paragraph colors={colors}>
              Em caso de emergência, ligue 192 (SAMU) ou procure um hospital
              imediatamente.
            </Paragraph>
            <Paragraph colors={colors}>
              Sempre consulte um médico, pediatra ou profissional de saúde
              qualificado para questões de saúde.
            </Paragraph>
          </View>
        </Section>
        ...
        <Section title="6. Propriedade Intelectual" colors={colors}>
          <Paragraph colors={colors}>
            Todo conteúdo do app (textos, vídeos, imagens, código, marca) é
            propriedade da Nossa Maternidade ou de seus licenciadores, protegido
          ...
          <Paragraph colors={colors}>
            ...
            Você mantém direitos sobre posts, fotos e comentários que publica.
            Ao postar, você nos concede licença mundial, não exclusiva, para
            exibir, reproduzir e distribuir seu conteúdo no contexto do Serviço.
          </Paragraph>
        </Section>
        ...
        <Section title="7. Moderação de Conteúdo" colors={colors}>
          <Paragraph colors={colors}>
            ...
            Termos, sem aviso prévio. Podemos suspender ou encerrar contas que
            violem repetidamente nossas diretrizes.
          </Paragraph>
          <Paragraph colors={colors}>
            Conteúdos proibidos incluem (mas não se limitam a):
          </Paragraph>
          <BulletPoint colors={colors}>
            Discurso de ódio, racismo, discriminação
          </BulletPoint>
          <BulletPoint colors={colors}>
            Nudez ou conteúdo sexual explícito
          </BulletPoint>
          <BulletPoint colors={colors}>
            Violência ou auto-lesão
          </BulletPoint>
          <BulletPoint colors={colors}>
            Spam, golpes ou fraudes
          </BulletPoint>
          <BulletPoint colors={colors}>
            Informações médicas falsas ou perigosas
          </BulletPoint>
        </Section>
        ...
        <Section title="9. Encerramento de Conta" colors={colors}>
          <Paragraph colors={colors}>
            Você pode deletar sua conta a qualquer momento em Configurações →
            Conta → Deletar Conta. Seus dados serão anonimizados ou deletados
        ...
        <Section title="10. Isenções de Garantia" colors={colors}>
          <Paragraph colors={colors}>
            ...
            garantias de qualquer tipo. Não garantimos que o Serviço será
            ininterrupto, livre de erros ou 100% seguro.
          </Paragraph>
        </Section>
        ...
        <Section title="11. Limitação de Responsabilidade" colors={colors}>
          <Paragraph colors={colors}>
            Na extensão máxima permitida por lei, Nossa Maternidade não será
            responsável por:
          </Paragraph>
          <BulletPoint colors={colors}>
          ...
          <Paragraph colors={colors} style={{ marginTop: 12 }}>
            Nossa responsabilidade total nunca excederá o valor pago por você nos
        ...
        <Section title="12. Lei Aplicável e Foro" colors={colors}>
          <Paragraph colors={colors}>
            ...
            Brasil. Qualquer disputa será resolvida no foro da comarca de [Cidade
            da Sede da Empresa], com exclusão de qualquer outro.
          </Paragraph>
        </Section>
        ...
        <Section title="13. Alterações nos Termos" colors={colors}>
          <Paragraph colors={colors}>
            ...
            significativas serão notificadas via email ou notificação no app.
            Continuar usando o Serviço após alterações constitui aceitação dos
            novos Termos.
          </Paragraph>
        </Section>
