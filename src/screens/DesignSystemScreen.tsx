        ...
        <Container>
          ...
          <Stack space="4" style={{ paddingTop: Spacing['6'], paddingBottom: Spacing['8'] }}>
            ...
            <Body color="secondary">
              Showcase de todos os componentes do sistema de design
            </Body>
          </Stack>
          ...
          <Section title="Toasts">
            <Stack space="2">
              ...
              <Card
                ...
                pressable
                onPress={() =>
                  toast.show({ message: 'Atenção necessária!', variant: 'warning' })
                }
              >
          ...
          <Section title="Skeleton Loading">
            <Stack space="3">
              ...
              >
                <Body>
                  {showSkeleton ? 'Ocultar' : 'Mostrar'} Skeletons (toque aqui)
                </Body>
              </Card>
