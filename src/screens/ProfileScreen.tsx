...
const EMOTION_OPTIONS = [
  'Ansiosa', 'Feliz', 'Cansada', 'Esperançosa', 'Estressada',
  'Grata', 'Preocupada', 'Animada', 'Sobrecarregada', 'Confiante',
];

// Opções de necessidades
const NEEDS_OPTIONS = [
  'Sono', 'Apoio emocional', 'Informação médica', 'Dicas práticas',
  'Conversar', 'Relaxamento', 'Orientação nutricional', 'Exercícios',
];

// Opções de interesses
const INTERESTS_OPTIONS = [
  'Aleitamento', 'Saúde mental', 'Desenvolvimento do bebê', 'Sono do bebê',
  'Alimentação', 'Relacionamento', 'Fé', 'Autocuidado', 'Volta ao trabalho',
];
...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    try {
      ...
      if (!success) {
        const errorMsg = typeof error === 'string' ? error : error instanceof Error ? error.message : 'Erro ao salvar';
      ...
      haptics.error();
      const errorMessage = error instanceof Error ? error.message : 'Não foi possível salvar suas alterações. Tente novamente.';
            ...
            {MOTHERHOOD_STAGES.map((stage) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  { borderColor: motherhoodStage === stage.value ? colors.primary.main : colors.border.light },
                ]}
                accessibilityRole="button"
              >
                <Text
            ...
            {EMOTION_OPTIONS.map((emotion) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  { borderColor: emotions.includes(emotion) ? colors.primary.main : colors.border.light },
                ]}
                accessibilityRole="button"
              >
                <Text
            ...
            {INTERESTS_OPTIONS.map((interest) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  { borderColor: interests.includes(interest) ? colors.primary.main : colors.border.light },
                ]}
                accessibilityRole="button"
              >
                <Text
