    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background.canvas }}>
      ...
      >
        ...
        {currentFile ? (
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: Tokens.spacing['3'] }}>
            ...
            {currentFile.change.description && (
              <Text style={{ fontSize: 14, color: colors.text.secondary, marginBottom: Tokens.spacing['3'] }}>
                {currentFile.change.description}
              </Text>
            )}
          ...
          >
            ...
            <Text style={{ fontSize: 14, color: colors.text.secondary, marginTop: Tokens.spacing['2'] }}>
        ...
        {currentFile && stats.pending > 1 && (
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: Tokens.spacing['2'] }}>
              ...
              <Text style={{ color: colors.primary.main, fontWeight: '600' }}>Review Next File</Text>
            </View>
          </HapticButton>
        )}
