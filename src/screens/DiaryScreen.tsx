        ...
        {!response ? (
          ...
          <View>
            ...
            <View className="flex-row gap-4 mb-8">
              <View
                style={{ width: 32, height: 32, borderRadius: 16, overflow: 'hidden', borderWidth: 1.5, borderColor: colors.border.light, shadowColor: colors.raw.neutral[900], shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 2, elevation: 2 }}
                accessible={true}
