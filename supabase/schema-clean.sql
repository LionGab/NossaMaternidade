-- ============================================
-- NOSSA MATERNIDADE - DATABASE SCHEMA (CLEAN)
-- Versão que limpa e recria tudo corretamente
-- ============================================
...
-- ============================================
-- PASSO 1: REMOVER TABELAS EXISTENTES (em ordem reversa)
-- ============================================
...
-- ============================================
-- PASSO 2: CRIAR TABELAS (em ordem correta)
-- ============================================
...
-- IMPORTANTE: Criar ANTES de chat_messages
-- ============================================
...
-- IMPORTANTE: Criar DEPOIS de chat_conversations
-- ============================================
...
-- ============================================
CREATE TABLE public.user_baby_milestones (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  user_id UUID REFERENCES public.profiles(id) ON DELETE CASCADE NOT NULL,
