-- ============================================
-- NOSSA MATERNIDADE - DATABASE SCHEMA (FIXED)
-- Versão corrigida para evitar erros de ordem
-- ============================================
...
-- ============================================
-- DROP EXISTING TABLES (se houver - em ordem reversa para respeitar foreign keys)
-- ============================================
...
-- Aplicar triggers (DROP IF EXISTS primeiro)
...
-- Drop índices existentes se houver (opcional - pode dar erro se não existirem)
